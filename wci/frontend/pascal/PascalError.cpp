...
EnumMap<PascalErrorCode, string> PascalError::SYNTAX_ERROR_MESSAGES;
...
void PascalError::initialize()
{
    ...
    vector<PascalErrorCode> error_codes =
    {
        ...
        PascalErrorCode::MISSING_BREAK_ARROW,
        PascalErrorCode::DANGLING_WHEN,
