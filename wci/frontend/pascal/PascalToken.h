...
{
public:
    static StringMap<string, PascalTokenType> RESERVED_WORDS;
    static StringMap<string, PascalTokenType> SPECIAL_SYMBOLS;
    static EnumMap<PascalTokenType, string> SPECIAL_SYMBOL_NAMES;
