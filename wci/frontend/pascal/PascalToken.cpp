...
StringMap<string, PascalTokenType> PascalToken::RESERVED_WORDS;
StringMap<string, PascalTokenType> PascalToken::SPECIAL_SYMBOLS;
EnumMap<PascalTokenType, string> PascalToken::SPECIAL_SYMBOL_NAMES;
