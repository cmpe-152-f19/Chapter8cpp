...
constexpr PascalErrorCode MISSING_BREAK_ARROW = PascalErrorCode::MISSING_BREAK_ARROW;
constexpr PascalErrorCode DANGLING_WHEN = PascalErrorCode::DANGLING_WHEN;
...
{
public:
    static EnumMap<PascalErrorCode, string> SYNTAX_ERROR_MESSAGES;
